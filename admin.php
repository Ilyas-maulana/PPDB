                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <h6 class="mb-0"><?php echo $row['total_siswa'];?></h6>
                                <p class="mb-2">Jumlah Pendaaftaran</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
              ...
              ?>
               ...
               <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa fa-chart-bar fa-3x text-primary"></i>
                            <div class="ms-3">
                                <h6 class="mb-0">Rp. <?php echo number_format($total_income, 0,',', '.');?></h6>
                                <p class="mb-2">income harian</p>
