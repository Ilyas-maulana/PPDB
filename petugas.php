                ...
                <div class="navbar-nav w-100">
                    <div class="nav-item dropdown"> 
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="#" class="dropdown-item">Registrasi</a>
                            <a href="#" class="dropdown-item">Input Gelombang</a>   
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-th me-2"></i>pendaftaran</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="#" class="dropdown-item">Daftar Baru</a>
                            <a href="#" class="dropdown-item">Data Siswa</a>
                            <a href="#" class="dropdown-item">Data kaos</a>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">YASNIBOS</span>
                        </a>
                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Jumlah Pendaftaran</p>
                                <h6 class="mb-0">2</h6>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                ?>
                     <div class= "d-sm-flex justify-content-center justify-content-sm-between">
                        <span class=" d-block text_center text-sm-left d-sm-inline-block" style="font-size:20px;">RP.<?php echo $row['total_pengurangan'];?></span>
                        </div>
                        </footer>
